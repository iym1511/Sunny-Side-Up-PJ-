  ...
  return (
    <HomeBoxWallpaper>
      <FooterDiv isActive={footerBtn}>
        ...
        <p>
          Copyright ⓒ 2023 by SunnySideUp All Pictures cannot be copied without
          permission
        </p>
      </FooterDiv>
      ...
      <HomeAboutBox>
        <HomeAboutDiv>
          ...
          <h1>S/U</h1>
          <p>
            SU(SunnySideUp)은 2023년에 태어났어요
            <br />
            삶을 가치있는 것들로 골고루 채우고 살자는 다짐같은 의미를 담았습니다
            <br />
            그래서 삶의 소중한 순간들을 SunnySideUp에 담았습니다
            <br />
            그리고 그 날씨들로 계획을 만듭니다
            <br />
            사람들이 SunnySideUp의 날씨 보고 삶의 소중한 순간들을 함께
            기억했으면 좋겠습니다.
            <br />
          </p>
          <br />
        ...
        <FooterBtn
          isActive={footerBtn}
          onClick={() => setFooterBtn(!footerBtn)}
        >
